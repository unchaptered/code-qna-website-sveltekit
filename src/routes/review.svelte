...
<section class="bg-gray-100">
    <div class="px-4 py-16 mx-auto max-w-screen-2xl sm:px-6 lg:px-8">
      <div class="items-end justify-between sm:flex">
        <div class="max-w-xl">
          <h2 class="text-4xl font-bold tracking-tight sm:text-5xl">리뷰를 남겨주세요!</h2>
  
          <p class="max-w-lg mt-8 text-gray-500">
              개발 시작일 : 2022년 4월 1일<br>
              최종 업데이트 : 2022년 4월 2일
          </p>
        </div>
  
        <!-- 리뷰 보기 버튼 -->
        <a href="#" class="inline-flex items-center flex-shrink-0 px-5 py-3 mt-8 font-medium text-pink-600 border border-pink-600 rounded-full sm:mt-0 lg:mt-8 hover:bg-pink-600 hover:text-white">
          리뷰 보기
          <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
        </a>
      </div>
      ...
      <div class="grid grid-cols-1 gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <blockquote class="flex flex-col justify-between h-full p-12 bg-white">
          <div>
            ...
            <div class="mt-4">
              <h5 class="text-xl font-bold text-pink-600 sm:text-2xl">내 생에 최악의 리뷰</h5>
          ...
          <footer class="mt-8 text-gray-500">유저이름, 2022-04-02</footer>
        </blockquote>
